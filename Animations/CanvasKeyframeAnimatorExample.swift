...
// » https://github.com/ralfebert/swiftui-garden/blob/main/Animations/CanvasKeyframeAnimatorExample.swift

import SwiftUI

struct CanvasKeyframeAnimatorExample: View {
...
extension Color: @retroactive Animatable {
    public var animatableData: AnimatableValues<CGFloat, CGFloat, CGFloat, CGFloat> {
        ...
        set {
            self = Color(red: newValue.value.0, green: newValue.value.1, blue: newValue.value.2, opacity: newValue.value.3)
        }
    }
}

#Preview {
    CanvasKeyframeAnimatorExample()
}
